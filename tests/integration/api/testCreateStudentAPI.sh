...
METHOD="POST"
TIME=$(date +%T)
BODY="{\"studentFirstName\":\"Testing\",\"studentLastName\":\"123\",\"studentEmail\":\"sumer.fly.guy@gmail.com\",\"studentCampus\":\"Cali\",\"studentIdentificationType\":\"Driving License\",\"studentIdentificationNumber\":\"23344556\"}"
